...
The term **Associated Files/Dependencies** may be used with respect to a [study file/resource](#study-filesresources) or with respect to a [final result product](#final-result-products).
